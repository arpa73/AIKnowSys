...
**Need security/performance/accessibility?** Switch to the full template.
...
**Stripped sections:** Security, Performance, Accessibility  
(Add these back if needed - see full template or SETUP_GUIDE.md)
