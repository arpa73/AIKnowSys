 ...
 */
export async function syncPlansCore(
  options: SyncPlansCoreOptions = {}
): Promise<SyncPlansCoreResult> {
...
> This file is regenerated automatically by plan/session workflows.  
...
**Verify:**
Run \`npx aiknowsys query-plans --status ACTIVE\` to verify active plan visibility.
