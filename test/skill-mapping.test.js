...
# Code Refactoring Guide`;
    ...
    it('should handle skills without YAML frontmatter', () => {
      const skillContent = `# TDD Workflow Skill
...
**When to use:** When dealing with slow queries`;
  ...
  describe('extractTriggerWords', () => {
    it('should extract trigger words from description', () => {
      const description = 'Use when refactoring components, removing duplication, or simplifying complex functions.';
      
      const triggers = extractTriggerWords(description);
    ...
    it('should extract trigger words from "When to use" section', () => {
      const skillContent = '**When to use:** When implementing new features, fixing bugs, or writing tests first.';
      
      const triggers = extractTriggerWords(skillContent);
    ...
    it('should handle quoted trigger words', () => {
      const description = 'User mentions: "refactor", "clean up", "simplify"';
...
**Purpose:** Update dependencies safely`
    ...
    it('should scan and return all skills in directory', async () => {
      const skills = await scanSkillsDirectory(fixturesDir);
  ...
  describe('generateSkillMapping', () => {
    it('should generate markdown table from skills', () => {
      ...
      const table = generateSkillMapping(skills);
