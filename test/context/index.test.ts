...
describe('createStorage factory', () => {
  ...
  describe('createStorage', () => {
    it('should create SqliteStorage adapter by default', async () => {
    ...
    it('should create .aiknowsys directory if not exists (when using JSON adapter)', async () => {
    ...
    // The JSON index file is no longer generated by default
    // as SQLite is now the primary storage engine
