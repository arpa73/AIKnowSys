...
export const TEMPLATE_PATHS = {
  ...
  GIT_HOOK_SYNC_PLANS: 'templates/hooks/sync-plans.cjs'
} as const;
...
export const AVAILABLE_STACKS: Record<string, StackConfig> = {
  nextjs: {
    name: 'nextjs',
 ...
 */
export function getProjectTypeName(key: string): string {
 ...
 */
export function getFrameworkName(key: string | null | undefined): string {
  const names: Record<string, string> = {
    vue: 'Vue 3',
    react: 'React',
    svelte: 'Svelte',
