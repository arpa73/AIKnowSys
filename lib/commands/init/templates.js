 ...
 * @returns {Promise<void>}
 */
export async function installAgentsAndSkills(targetDir, answers, silent = false, essentialsFile = 'CODEBASE_ESSENTIALS.md') {
  ...
  // Generate skill mapping and update AGENTS.md
