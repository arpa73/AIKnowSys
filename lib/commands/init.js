...
function displayAIBootstrapPrompt(projectName, hasCode) {
  console.log('');
  ...
  const promptLines = hasCode 
    ? [
        ...
        '',
        '4. Make everything specific to MY codebase, not generic',
        '',
    ...
    : [
        ...
        '',
        'My project directory is currently empty. Please help me:',
        '',
        '1. First, let\'s design the project together:',
        ...
        '',
        '2. Then, help me set up the initial codebase:',
        '   - Create the project structure',
        '   - Set up package.json / pyproject.toml / Cargo.toml',
        '   - Add necessary config files',
        '   - Create a basic "Hello World" implementation',
        '',
        '3. Finally, complete the knowledge system files:',
        '   - Read CODEBASE_ESSENTIALS.md, AGENTS.md, CODEBASE_CHANGELOG.md',
        '   - Fill in all TODO sections based on what we built together',
        '   - Make it specific to our project architecture',
        '',
        'Let\'s start by discussing what I want to build."'
      ];
  ...
  if (hasCode) {
    ...
    console.log(chalk.white('   1. Discuss your project vision with AI'));
    console.log(chalk.white('   2. AI helps you design the architecture'));
    console.log(chalk.white('   3. AI sets up the initial codebase structure'));
    console.log(chalk.white('   4. AI completes the knowledge system documentation'));
    console.log(chalk.white('   5. You have a fully bootstrapped project!'));
  }
  console.log('');
...
export async function init(options) {
  ...
  // Step 1: Ask setup mode FIRST (AI-guided or manual)
  let setupMode;
  let answers;
  ...
  try {
    ...
    // Step 5: OpenSpec installation (if team project)
    if (answers.useOpenSpec || answers.isTeamProject) {
      console.log('');
    ...
    if (setupMode === 'ai') {
      displayAIBootstrapPrompt(answers.projectName, hasCode);
    } else {
