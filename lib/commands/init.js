...
function displayAIBootstrapPrompt(projectName, hasCode) {
  ...
  const promptLines = hasCode 
    ...
    : [
        ...
        '',
        '1. First, let\'s discuss and design the project:',
        ...
        '',
        '2. Then, document the architecture in the knowledge system:',
        ...
        '',
        '3. Finally, build the initial codebase following the documented architecture:',
        '   - Create the project structure we documented',
        '   - Set up package.json / pyproject.toml / Cargo.toml',
        '   - Add config files matching our documented patterns',
        '   - Create a basic "Hello World" following our conventions',
        '',
        '⚠️  IMPORTANT: Complete steps 1-2 (design + document) BEFORE writing any code!',
        '',
  ...
  if (hasCode) {
    ...
    console.log(chalk.white('   3. AI builds the codebase following the documented patterns'));
    console.log(chalk.white('   4. You have a fully documented, AI-assisted project!'));
  }
  console.log('');
