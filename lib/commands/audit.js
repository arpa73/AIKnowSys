...
export async function audit(options) {
  ...
  if (spinner) spinner.text = 'Check 1/5: Checking for duplication issues...';
  ...
  if (spinner) spinner.text = 'Check 2/5: Checking placeholder quality...';
  ...
  if (spinner) spinner.text = 'Check 3/5: Checking validation matrix quality...';
  ...
  if (spinner) spinner.text = 'Check 4/5: Checking changelog...';
  ...
  if (spinner) spinner.text = 'Check 5/5: Checking .aiknowsys/ gitignore...';
