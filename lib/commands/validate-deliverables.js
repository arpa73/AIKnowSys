 ...
 */
async function checkMaintainerSkillBoundary(projectRoot, _log) {
  const issues = [];
 ...
 */
async function validateTemplateSchema(projectRoot, _log, _options) {
  const issues = [];
  let templatesChecked = 0;
  let patternsValidated = 0;
 ...
 */
async function validatePatternConsistency(projectRoot, _log, _options) {
  const issues = [];
  let patternsValidated = 0;
 ...
 */
async function detectLegacyPatterns(projectRoot, _log, _options) {
  const issues = [];
  const fixable = [];
 ...
 * @returns {Promise<{name: string, passed: boolean, issues: string[]}>}
 */
async function detectUnresolvedPlaceholders(projectRoot, _log) {
  const issues = [];
 ...
 * @returns {Promise<{name: string, passed: boolean, issues: string[]}>}
 */
async function testTemplateExecution(_projectRoot, _log) {
  const issues = [];
 ...
 * @returns {Promise<{name: string, passed: boolean, issues: string[]}>}
 */
async function testFreshInit(_projectRoot, _log) {
  const issues = [];
