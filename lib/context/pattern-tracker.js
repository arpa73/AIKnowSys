 ...
 * @returns {string} Path to pattern-history.json
 */
function getHistoryPath(targetDir) {
 ...
 * @param {string} targetDir - Project root directory
 * @returns {Promise<Object>} Pattern history data
 */
 ...
 * @param {string} targetDir - Project root directory
 * @param {Object} data - Pattern history data
 */
async function saveHistory(targetDir, data) {
  const historyPath = getHistoryPath(targetDir);
 ...
 * @param {string} targetDir - Project root directory
 */
export async function initPatternTracking(targetDir) {
 ...
 * @param {string} targetDir - Project root directory
 * @param {Object} pattern - Pattern to track { error, resolution }
 */
export async function trackPattern(targetDir, pattern) {
  const history = await loadHistory(targetDir);
 ...
 * @param {string} targetDir - Project root directory
 * @param {string} error - Error pattern to mark
 */
export async function markPatternDocumented(targetDir, error) {
  const history = await loadHistory(targetDir);
 ...
 */
export async function getPatterns(targetDir) {
  const history = await loadHistory(targetDir);
